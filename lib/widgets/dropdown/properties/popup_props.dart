...
import 'package:ukel/widgets/dropdown/properties/bottom_sheet_props.dart';
import 'package:ukel/widgets/dropdown/properties/custom_widget_props.dart';
import 'package:ukel/widgets/dropdown/properties/dialog_props.dart';
import 'package:ukel/widgets/dropdown/properties/favorite_item_props.dart';
import 'package:ukel/widgets/dropdown/properties/list_view_props.dart';
import 'package:ukel/widgets/dropdown/properties/menu_props.dart';
import 'package:ukel/widgets/dropdown/properties/modal_bottom_sheet_props.dart';
import 'package:ukel/widgets/dropdown/properties/scrollbar_props.dart';
import 'package:ukel/widgets/dropdown/properties/text_field_props.dart';
...
class PopupProps<T> {
  ...
  final CustomWidgetProps customWidgetProps;
  ...
  const PopupProps._({
    ...
    this.customWidgetProps = const CustomWidgetProps(),
...
class PopupPropsMultiSelection<T> extends PopupProps<T> {
  ...
  const PopupPropsMultiSelection._({
    ...
    super.showSearchBox,
    super.showCustomWidget,
    super.customWidgetProps = const CustomWidgetProps(),
  ...
  PopupPropsMultiSelection.from(PopupProps<T> popupProps)
      : this._(
          ...
          showCustomWidget: popupProps.showCustomWidget,
          customWidgetProps: popupProps.customWidgetProps,
