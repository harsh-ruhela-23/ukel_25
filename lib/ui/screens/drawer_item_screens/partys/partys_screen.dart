...
import 'package:ukel/ui/screens/drawer_item_screens/partys/partys_details_screen.dart';
...
class PartyScreen extends StatefulWidget {
  ...
  const PartyScreen(this.showAppBar, {Key? key}) : super(key: key);
  ...
  void getCustomersList() async {
    try {
      ...
      if (!isCustomerListFetchingData) {
        ...
        await repository.fetchCustomers(branchId : branchId).then((list) {
          if (list.isNotEmpty) {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              // build SearchFieldCustomers
              buildSearchFieldCustomers(),
              SizedBox(height: 15.sp),

              // Customer List
              isCustomerListFetchingData
                  ? Padding(
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => PartyDetailsScreen(
                          customerData: searchResult[index],
                        ),
                      ),
                    );
                  },
          ...
          child: GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => PartyDetailsScreen(
                      customerData: customersList[index],
                    ),
                  ),
                );
              },
