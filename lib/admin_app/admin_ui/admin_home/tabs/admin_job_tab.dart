...
class AdminJobTab extends StatefulWidget {
  const AdminJobTab({super.key, this.branchId});

  final String? branchId;

  @override
  State<AdminJobTab> createState() => _AdminJobTabState();
}

class _AdminJobTabState extends State<AdminJobTab> {
                            ...
                            child: RefreshIndicator(
                              ...
                              child: GroupedListView(
                                ...
                                itemComparator: (item1, item2) =>
                                    item1.serviceInvoiceCreatedAtDate.compareTo(
                                        item2.serviceInvoiceCreatedAtDate),
